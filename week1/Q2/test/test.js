...
describe("Multiplier3 with Groth16", function () {
    ...
    it("Circuit should multiply three numbers correctly", async function () {
        VerifierFactory = await ethers.getContractFactory("MultiplierVerifier");
    ...
    it("Should return true for correct proof", async function () {
        ...
        assert(Fr.eq(Fr.e(witness[0]),Fr.e(1)));
        assert(Fr.eq(Fr.e(witness[1]),Fr.e(80)));

        const {proof, publicSignals} = await groth16.fullProve({"a": 2, "b": 5, "c": 8}, "contracts/circuits/Multiplier3/Multiplier3_js/Multiplier3.wasm","contracts/circuits/Multiplier3/circuit_final.zkey");
